...
{
  final tabList = ['الباقيات الصالحات', 'حصن المسلم '];
  ...
  Widget build(BuildContext context) {
         return Scaffold(
           appBar: AppBar(
               ...
               title: Text('أذْكَارِيٌّ',textAlign:TextAlign.center, style:
               TextStyle(fontSize: 35, fontWeight: FontWeight.w700,color: Color(0xff090088)),),
               centerTitle: true,
               actions: [
                 Padding(
